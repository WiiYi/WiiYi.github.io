function display2_1() {
  var myanswer  = "My answer goes here: The first console.log will give undefined, the second will give true and the third will give false. For the second console.log it is comparing the value of null and undefined, the third console.log it is also comparing the type and value." // TODO 2.1: Fill in Answer here after the :
  document.getElementById("21answer").innerHTML = myanswer; // Do not change
}
function display2_2() {
  var myanswer  = "My answer goes here: It will give an error that x is not defined. If remove the use strict it will run as normal. Because the use strict will not all using undefined variables." // TODO 2.2: Fill in Answer here
  document.getElementById("22answer").innerHTML = myanswer; // Do not change
}

function display2_5() {
  var myanswer  = "My answer goes here: The tag are not visible because it has the style = display :none. Which will hid the whole tag. But the function doesn't consider the display style." // TODO 2.5: Fill in Answer here
